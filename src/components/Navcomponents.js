...
export function Home(){
    return(
        <section style={{padding:"10px 0px",backgroundColor: "rgba(131, 200, 139,100)"}} id="Home">
                ...
                <div className="row justify-content-center bg-success">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hello Developers Dhruv this side,</h1>
...
export function About(){
    return(
        <section id="intro" className='mt-2' style={{backgroundColor: "#13cecf"}}>
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "#13cecf"}}>
                        <h1>
                            <div class="display-4">Dhruv Goyal</div>
                            <div class="lead text-muted"><i class="bi bi-file-earmark-person"></i>Web Developer</div>
                        </h1>
                        <hr />
                        <div class="contact">
                            <p class="lead pt-0">Currently I am working with MERN Stack and AI/ML</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> Reach me at: 
                                <a href="mailto:dhruvgoyal3726@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> Hisar,Haryana</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/dhruv-goyal-9b4159227" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> LinkedIn</a>
                                <a href="https://github.com/dhruvgoyal9999" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://leetcode.com/dhruvgoyal9999/" target="_blank" class="btn btn-sm btn-danger fw-bold">LeetCode</a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="Dhruv Goyal">
...
export function Info(){
    return(
        <section id="info" class="bg-success mt-5" style={{padding: "60px 0px"}}>
            <div class="container-lg">
                <div class="text-center">
                    <h2><i class="bi bi-info-circle-fill d-none d-md-inline"></i>Technologies currently working on </h2>
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                <h5 class="card-title">Practiced Projects</h5>
                                <p class="card-text mx-3 my-1 text-muted d-none d-lg-block">MERN is one of several variations of the MEAN stack (MongoDB Express Angular Node), where the traditional Angular.js front-end framework is replaced with React.js. Other variants include MEVN (MongoDB, Express, Vue, Node), and really any front-end JavaScript framework can work</p>
                                <a href="https://github.com/dhruvgoyal9999?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                <h5 class="card-title">Practiced Projects</h5>
                                <p class="card-text mx-3 my-1 text-muted d-none d-lg-block">Machine learning is a branch of artificial intelligence (AI) and computer science which focuses on the use of data and algorithms to imitate the way that humans learn, gradually improving its accuracy. It is future emerging technology in collab with data science</p>
                                <a href="https://github.com/dhruvgoyal9999?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
...
export function Contact(){
    return(
        <section id="contact" style={{backgroundColor: "#dee30c"}}>
            <div class="container-lg">
                <div class="text-center">
    ...
    return(
        <section id="projects">
            <div class="container-md">
                <div class="text-center">
                    <h2><i class="bi bi-person-workspace"></i> Two Major Project</h2>
                    <p class="lead text-muted">Please checkout my Projects</p>
                </div>
                        ...
                        <div class="accordion" id="projects_list">
                            <div class="accordion-item">
                                ...
                                <div id="project-1" class="accordion-collapse collpase show" aria-labelledby="heading-1" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://github.com/dhruvgoyal9999/Hangman-Game" class="btn btn-outline-danger me-2" >App</a>
                                        <a href="https://github.com/dhruvgoyal9999/Hangman-Game" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading-2">
                                    ...
                                    Unblurring-Users-Sentiments-on-Reddit
                                    </button>
                                </h2>
                                <div id="project-2" class="accordion-collapse collpase" aria-labelledby="heading-2" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://dhruvgoyal9999.github.io/Unblurring-Users-Sentiments-on-Reddit/" target="_blank" class="btn btn-outline-danger" >Deployed</a>
                                    </div>
                                </div>
                            </div>
                        </div>
